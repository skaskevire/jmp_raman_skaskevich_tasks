 ...
 * */
public class AppendEngineMenuLineEntry extends MenuEntry {

	public static final String PACKAGE_SIZE_MSG = "Package size: ";
	private static final Logger LOGGER = LogManager
			.getLogger(AppendEngineMenuLineEntry.class);

	public AppendEngineMenuLineEntry(String filePath) {
		super(filePath);
		setTitle(MenuEntryEnum.APPEND_LINE_ENGINE.getMessage());
	}

	public AppendEngineMenuLineEntry() {
		setTitle(MenuEntryEnum.APPEND_LINE_ENGINE.getMessage());
	}
	...
	public void performMenuAction() {
		try {
			...
			Class<?> clazz = jarLoader
					.loadClass(MenuEntryEnum.APPEND_LINE_ENGINE.getClassName());
